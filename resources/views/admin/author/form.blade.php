...
<div class="card">
  <div class="card-header bg-white">
    <h4 class="mb-0 p-2 font-weight-bolder">Author Detail</h4>
  </div>
  <div class="card-body">
      @if(isset($author))
      <form method="post" action="{{route('admin.author.update', $author->id)}}">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="form-group form-float">
                          <div class="form-line">
                              ...
                              <input value="{{@$author->title}}" id="title" name="title" class="form-control" type="text">
                          </div>
                      </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="form-group form-float">
                          <div class="form-line">
                              ...
                              <input id="permalink" value="{{@$author->permalink}}" name="permalink" class="form-control" type="text">
                          </div>
                      </div>
                  </div>
              <div class="clearfix"></div>
                ...
                <label>Feature Image</label>
                      <div class="thumbnail-container clearfix">
                        ...
                        <input id="thumbnail" name="image" value="<?php echo @$author->image;?>" type="hidden">
                      <div id="thumbnail_preview" class="media-image-content">
                        @if(@$author->media)
                          {!!@$author->media->get_attachment()!!}
                        @endif
                      </div>
                      </div>
                    </div>
                  <div class="col-md-12 col-sm-12 col-xs-12 mt-4">
                    ...
                    <textarea id="description" name="detail" class="WYSWIYG large">{!!@$author->detail!!}</textarea>
                  </div>
                </div>
                </div>
                <div class="tab-pane" id="meta_information">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <textarea rows="3" class="form-control no-resize" name="meta_title" id="meta_title">{{@$author->meta_title}}</textarea>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <textarea rows="3" class="form-control no-resize" name="meta_description" id="meta_description">{{@$author->meta_description}}</textarea>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <textarea rows="3" name="meta_keyword" id="meta_keyword" class="form-control no-resize" >{{@$author->meta_keyword}}</textarea>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select name="meta_robot" id="meta_robot" class="form-control show-tick ms">
                      ...
                      foreach ($meta_robots as $key ) { ?>
                        <option value="<?php echo $key; ?>" <?php if($key==@$author->meta_robot) echo 'selected="selected"'; ?>><?php echo $key; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
